...
// Thin HTTP layer on purpose: validate the Kuali request, create/update a job row,
// then hand the real work to ImportService. Keeping route code boring makes the
// retry and cleanup behavior easier to follow in SERVICES.
public static class ImportController
{
    ...
    {
        var log = loggerFactory.CreateLogger("ImportController");
    ...
    private static async Task MarkFailedAsync(JobStore queue, ImportJob job, Exception ex, CancellationToken ct)
    {
